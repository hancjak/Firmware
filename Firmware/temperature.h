...
extern int target_temperature_bed2;
extern float current_temperature_bed2;
...
FORCE_INLINE float degHotend(uint8_t extruder) {  
  ...
  FORCE_INLINE float rawBedTemp2() {
	  return current_temperature_bed2_raw;
  };
#endif
...
FORCE_INLINE float degBed2() {
	return current_temperature_bed2;
};
...
FORCE_INLINE float degTargetBed2() {
	return target_temperature_bed2;
};
...
FORCE_INLINE void setTargetBed2(const float &celsius) {
	target_temperature_bed2 = celsius;
};
...
FORCE_INLINE bool isHeatingBed2() {
	return target_temperature_bed2 > current_temperature_bed2;
};
...
FORCE_INLINE bool isCoolingBed2() {
	return target_temperature_bed2 < current_temperature_bed2;
};
